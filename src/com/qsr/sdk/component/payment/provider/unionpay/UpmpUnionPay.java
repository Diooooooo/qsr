 ...
 * */
public class UpmpUnionPay {

	//static Logger logger = Logger.getLogger(UpmpService.class);
	...
	/**
	 * wujp add ,submit order
	 * 交易接口处理
	 * @param req 请求要素
	 * @param resp 应答要素
	 * @return 是否成功
	 */
	public static String submitOrder(Map<String, String> req, Map<String, String> resp) {
		String nvp = buildReq(req);
		//logger.info("向银联提交订单字条串：" + nvp);
		return HttpUtil.post(UpmpConfig.TRADE_URL, nvp);
	}
