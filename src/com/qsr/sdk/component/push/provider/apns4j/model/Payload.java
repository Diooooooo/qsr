...
public class Payload {
	...
	public String toString() {
		...
		// JSONObject apsObj = new JSONObject();
		if (getAlert() != null) {
			apsObj.addProperty("alert", getAlert());
		} else {
			if (getAlertBody() != null || getAlertLocKey() != null) {
				JsonObject alertObj = new JsonObject();
				// JSONObject alertObj = new JSONObject();
		...
		if (getBadge() != null) {
			apsObj.addProperty("badge", getBadge().intValue());
		}
		putIntoJson("sound", getSound(), apsObj);

		if (getContentAvailable() != null) {
			apsObj.addProperty("content-available", getContentAvailable()
					.intValue());
		}

		object.add(APS, apsObj);
		if (getParams() != null) {
			for (Entry<String, Object> e : getParams().entrySet()) {
				Object value = e.getValue();
				if (value instanceof String) {
					object.addProperty(e.getKey(), (String) value);
				} else if (value instanceof Character) {
					object.addProperty(e.getKey(), (Character) value);
				} else if (value instanceof Number) {
					object.addProperty(e.getKey(), (Number) value);
				} else if (value instanceof Boolean) {
					object.addProperty(e.getKey(), (Boolean) value);
				} else if (value != null) {
					object.addProperty(e.getKey(), value.toString());
				}
